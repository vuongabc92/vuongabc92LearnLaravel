                    ...
                    <div class="_fwfl setting-group">
                        ...
                        <div class="_fr setting-field-right">
                            <div class="_fl setting-form-group setting-form-group-store">
                                ...
                                {!! Form::text('name', '', ['class' => '_fwfl setting-form-field', 'id' => 'street', 'maxlength' => '250']) !!}
                            </div>
                            <div class="_fl setting-form-group setting-form-group-store">
                                <label class="_fwfl setting-form-label" for="city" data-title="{{ _t('province') }}">{{ _t('province') }}</label>
                                {!!
                                    Form::select('city', [_t('select_city'), 'Clothes', 'Car', 'Mobile'] , null, ['id' => 'city', 'class' => '_fwfl setting-form-field selectbox-field']) 
                                !!}
                            </div>
                            <div class="_fl setting-form-group setting-form-group-store">
                                <div class="_w50 _fl _pr3">
                                    <label class="_fwfl setting-form-label" for="district" data-title="{{ _t('district') }}">{{ _t('district') }}</label>
                                    {!!
                                        Form::select('district', [_t('select_district'), 'Clothes', 'Car', 'Mobile'] , null, ['id' => 'district', 'class' => '_fwfl setting-form-field selectbox-field']) 
                                    !!}
                                </div>
                                <div class="_w50 _fl _pl3">
                                    <label class="_fwfl setting-form-label" for="ward" data-title="{{ _t('ward') }}">{{ _t('ward') }}</label>
                                    {!!
                                        Form::select('ward', [_t('select_ward'), 'Clothes', 'Car', 'Mobile'] , null, ['id' => 'ward', 'class' => '_fwfl setting-form-field selectbox-field']) 
                                    !!}
                                </div>
                            </div>
                            <div class="_fl setting-form-group setting-form-group-store">
                                <label class="_fwfl setting-form-label" for="phone" data-title="{{ _t('fone_num') }}">{{ _t('fone_num') }}</label>
                                {!! Form::text('phone', '', ['class' => '_fwfl setting-form-field', 'id' => 'phone', 'maxlength' => '250']) !!}
